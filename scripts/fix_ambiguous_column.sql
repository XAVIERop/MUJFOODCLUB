-- =====================================================
-- Fix Ambiguous Column Reference in Rewards Function
-- =====================================================

-- 1. First, let's check what's causing the ambiguity
SELECT 
  '=== CHECKING COLUMN CONFLICTS ===' as section,
  column_name,
  table_name
FROM information_schema.columns 
WHERE column_name = 'current_tier';

-- 2. Fix the function by using proper table aliases
