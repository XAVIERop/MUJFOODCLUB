-- Complete Cafe Navigation Fix - Simple Version
...
-- =====================================================
-- 5. CREATE SIMPLE SYSTEM PERFORMANCE METRICS FUNCTION
-- =====================================================

-- Drop and recreate with simple approach
...
BEGIN
    -- Simple version that just returns basic counts
    RETURN QUERY
    SELECT 
...
DO $$
BEGIN
    RAISE NOTICE '🎉 Complete cafe navigation fix applied (Simple Version)!';
    ...
    RAISE NOTICE '✅ Created simple system performance metrics function';
