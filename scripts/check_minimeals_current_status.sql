-- Check Mini Meals current status
-- This will help us understand what's missing

-- Check 1: Does the auth account exist?
SELECT 
...
-- Check 2: Does the profile exist?
SELECT 
...
-- Check 4: What's the Mini Meals cafe ID?
SELECT 
  'Mini Meals Cafe' as check_type,
  c.id,
  c.name,
  c.location,
  c.is_active
