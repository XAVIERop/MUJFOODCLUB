-- Remove old duplicate Gravy Momos from Munch Box
-- This deletes the old separate Paneer/Veg cards
...
-- If the above query shows the right items, then uncomment and run the DELETE:
