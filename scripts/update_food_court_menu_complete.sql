-- Complete Food Court menu update with vegetarian segregation
-- This script first adds the is_vegetarian column, then updates all menu items
...
BEGIN
    ...
    -- ========================================
    -- ADD IS_VEGETARIAN COLUMN IF NOT EXISTS
    -- ========================================
    
    -- Add the is_vegetarian column to menu_items table if it doesn't exist
