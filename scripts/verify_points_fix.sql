...
-- 5. Verify tier calculation
SELECT 
  '=== TIER CALCULATION TEST ===' as section,
  calculate_cafe_tier(3000.00) as test_3000_spent,
  calculate_cafe_tier(4000.00) as test_4000_spent,
  calculate_cafe_tier(7000.00) as test_7000_spent,
  'Should be foodie, gourmet, connoisseur' as expected;
