    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-blue-50">
      ...
      <div className="relative bg-gradient-to-r from-purple-600 to-blue-600 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-4">ELICIT 2024</h1>
          <p className="text-xl md:text-2xl mb-2">Official Food Delivery Partner</p>
          <p className="text-lg opacity-90">ACM - Association for Computing Machinery</p>
          <div className="mt-8">
            <Badge className="bg-white text-purple-600 px-6 py-2 text-lg font-semibold">
              Special Event Menu
            </Badge>
          </div>
        </div>
