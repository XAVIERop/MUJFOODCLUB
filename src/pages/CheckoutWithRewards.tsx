...
const Checkout = () => {
  ...
  useEffect(() => {
    ...
    const deliveryCharge = 10; // ₹10 delivery charge for all cafes
    const finalAmountWithTaxes = subtotal + cgst + sgst + deliveryFee + deliveryCharge;
                ...
                <CardContent>
                  ...
                  <div className="mb-6 p-4 bg-muted/50 rounded-lg">
                    ...
                    <div className="mt-2 p-2 bg-yellow-50 rounded text-xs text-yellow-700">
                      <strong>Minimum Order:</strong> ₹{MINIMUM_ORDER_AMOUNT} required for all orders
                    </div>
                    
                    {/* Delivery Charge Notice */}
                    <div className="mt-2 p-2 bg-green-50 rounded text-xs text-green-700">
                      <strong>Delivery:</strong> ₹10 delivery charge added to all orders
                    </div>
                  </div>
            ...
            <div className="space-y-6">
              ...
              >
                {isLoading ? 'Placing Order...' : 
                 !isMinimumOrderMet ? `Minimum Order ₹${MINIMUM_ORDER_AMOUNT} Required` :
                ...
                <div className="mt-2 p-3 bg-red-50 border border-red-200 rounded-lg">
                  <div className="flex items-center text-red-700">
                    ...
                    <span className="text-sm font-medium">
                      Minimum order amount of ₹{MINIMUM_ORDER_AMOUNT} required. 
                      Add ₹{MINIMUM_ORDER_AMOUNT - totalAmount} more to place your order.
                    </span>
                  </div>
                </div>
              )}
