...
const Checkout = () => {
  ...
  useEffect(() => {
    ...
    const cgstAmount = subtotal * ORDER_CONSTANTS.CGST_RATE;
    const sgstAmount = subtotal * ORDER_CONSTANTS.SGST_RATE;
    const finalAmountWithTaxes = subtotal + cgstAmount + sgstAmount + deliveryCharge;
    ...
    try {
      ...
      const { data: order, error: orderError } = await supabase
        ...
        .insert({
          ...
          table_number: deliveryDetails.tableNumber,
          status: 'pending',
