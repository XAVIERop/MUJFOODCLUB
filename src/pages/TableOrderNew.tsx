  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      ...
      try {
        ...
        // Fetch order items with menu item details for WhatsApp
        ...
        if (itemsError) {
          console.error('📱 [TABLE ORDER] Error fetching order items:', itemsError);
        }
        ...
        const orderData = {
          ...
          order_items: orderItemsData?.map((item: any) => ({
